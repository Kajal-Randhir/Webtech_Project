...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <ul class="navi">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2" style="color:white;"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3" style="color:white;"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
...
<center><h1 class="title" ><input type="button" value="Exam submit" onclick="myfun1()" style="background:green ;"></h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';

echo '<tr style="color:#990000"><td>"Your Exam was Submitted Successfully!!!&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
}
echo '</table></div>';
