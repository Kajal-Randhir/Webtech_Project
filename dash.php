...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
   ...
   <ul class="navi">
        ...
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0"style="color:white;">Home<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1" style="color:white;">User</a></li>
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2" style="color:white;">Result</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="dash.php?q=3" style="color:white;">Feedback</a></li>
		<li <?php if(@$_GET['q']==6) echo'class="active"'; ?>><a href="dash.php?q=6" style="color:white;">History</a></li>
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white;">Quiz<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4" style="color:black;">Add Quiz</a></li>
            <li><a href="dash.php?q=5" style="color:black;">Remove Quiz</a></li>
			
          </ul>
        </li><li class="pull-right" style="color:white;"> <a href="logout.php?q=account.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true" ></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
...
if(@$_GET['q']== 0) {
	...
	echo'<h1 style="color:red;">WELCOME TO ADMINAL PANEL</h1>';
}
?>
</center>
</div>
